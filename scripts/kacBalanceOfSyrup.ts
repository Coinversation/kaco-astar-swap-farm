...
async function main() {
  ...
  const kaco = await ethers.getContractAt("IERC20", kacoAddress, await ethers.getSigner(mainAddress));

  console.log("kac balance of syrup: ", (await kaco.balanceOf(syrupShidenAddress)).toString());
  // console.log("cap: ", kaco.totalSupply) 
}
